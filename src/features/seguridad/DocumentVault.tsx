...
export function DocumentVault({ lang }: { lang: string }) {
    ...
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-end">
        <div className="space-y-1">
          <h2 className="text-2xl font-black text-primary uppercase tracking-tight">Bóveda</h2>
          <p className="text-[10px] text-muted-foreground font-black uppercase tracking-[0.2em]">Documentos Seguros</p>
        </div>
      ...
      {docs.length === 0 ? (
        <Card className="border-none bg-slate-50 rounded-[2.5rem] p-12 text-center text-muted-foreground flex flex-col items-center gap-4">
           ...
           <p className="text-sm font-bold">No hay documentos guardados.</p>
        </Card>
      ) : (
            ...
            <div className="relative w-full h-full flex flex-col">
              ...
              <div className="p-8 bg-black/80 backdrop-blur-xl border-t border-white/10 text-center space-y-4">
                 <div className="flex items-center gap-3 justify-center">
                    ...
                    <p className="text-xs font-bold text-white uppercase tracking-widest">Modo Emergencia Activo</p>
                 </div>
                 <p className="text-[10px] text-white/60 leading-normal">Este documento se muestra a pantalla completa para facilitar su lectura por autoridades.</p>
              </div>
            </div>
          </DialogContent>
        </Dialog>
